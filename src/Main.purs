...
component = H.mkComponent
  ...
  where
    initialState = 
      let (QuoteDatabase db) = sampleData
      in
...
sampleData :: QuoteDatabase
sampleData = QuoteDatabase
  { quotes: 
    [ Quote { id: 1, text: "Stay hungry, stay foolish.", author: "Steve Jobs", category: "motivation", year: Just 2005, source: "Stanford Commencement", tags: ["innovation", "learning"] }
    , Quote { id: 2, text: "Code is like humor. When you have to explain it, it's bad.", author: "Cory House", category: "programming", year: Nothing, source: "Twitter", tags: ["coding", "humor"] }
    , Quote { id: 3, text: "Talk is cheap. Show me the code.", author: "Linus Torvalds", category: "programming", year: Just 2000, source: "Linux Mailing List", tags: ["action", "programming"] }
    , Quote { id: 4, text: "The only way to learn a new programming language is by writing programs in it.", author: "Dennis Ritchie", category: "programming", year: Just 1978, source: "The C Programming Language", tags: ["learning", "programming"] }
    , Quote { id: 5, text: "Experience is the name everyone gives to their mistakes.", author: "Oscar Wilde", category: "wisdom", year: Just 1892, source: "Lady Windermere's Fan", tags: ["experience", "learning"] }
    ]
  , categories:
    [ Category { name: "programming", description: "Coding and software development", color: "#007acc" }
    , Category { name: "motivation", description: "Inspirational quotes", color: "#ff6b6b" }
    , Category { name: "wisdom", description: "Life wisdom and insights", color: "#4ecdc4" }
    ]
  , authors:
    [ Author { name: "Steve Jobs", bio: "Co-founder of Apple Inc.", birth_year: 1955, quote_count: 1 }
    , Author { name: "Linus Torvalds", bio: "Creator of Linux", birth_year: 1969, quote_count: 1 }
    , Author { name: "Dennis Ritchie", bio: "Creator of C programming language", birth_year: 1941, quote_count: 1 }
    ]
  }
