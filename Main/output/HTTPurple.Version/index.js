...
var showVersion = {
    show: function (v) {
        ...
        throw new Error("Failed pattern match at HTTPurple.Version (line 26, column 1 - line 32, column 44): " + [ v.constructor.name ]);
    }
};
var read = function ($16) {
    return (function (v) {
        ...
        return new Other(v);
    })(Node_HTTP_IncomingMessage.httpVersion($16));
};
var eqVersion = {
    eq: function (x) {
        return function (y) {
