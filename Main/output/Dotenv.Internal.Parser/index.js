...
var valueFromValues = function (v) {
    ...
    throw new Error("Failed pattern match at Dotenv.Internal.Parser (line 104, column 1 - line 104, column 60): " + [ v.constructor.name ]);
};
...
var quotedValue = function (q) {
    ...
    })(some(alt(Parsing_Combinators["try"](applySecond(applySecond(Parsing_String["char"]("\\"))(Parsing_String["char"](q)))(pure(q))))(alt(Parsing_String_Basic.noneOf([ "$", q ]))(Parsing_Combinators["try"](applyFirst(Parsing_String["char"]("$"))(Parsing_Combinators.notFollowedBy(Parsing_String_Basic.oneOf([ "{", "(" ]))))))));
