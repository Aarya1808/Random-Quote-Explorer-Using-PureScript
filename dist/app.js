(() => {
  ...
  var readInt = function(dictMonad) {
    ...
    return function(value14) {
      var error4 = new Left(singleton6(new TypeMismatch("Int", tagOf(value14))));
      ...
      return mapExceptT(map24(either($$const(error4))(fromNumber2)))(readNumber1(value14));
    };
  };
  ...
  var sampleData = /* @__PURE__ */ function() {
    return {
      quotes: [{
        id: 1,
      ...
      categories: [{
        ...
        name: "wisdom",
        description: "Life wisdom and insights",
        color: "#4ecdc4"
      }],
      authors: [{
        name: "Steve Jobs",
  ...
  var renderTag = function(tag) {
    return span3([class_("tag")])([text5(tag)]);
  };
      ...
      if (state3.currentQuote instanceof Just) {
        return div2([class_("quote-box active")])([blockquote([class_("quote-text")])([text5('"' + (state3.currentQuote.value0.text + '"'))]), div2([class_("quote-attribution")])([cite_([text5("\u2014 " + state3.currentQuote.value0.author)]), function() {
          if (state3.currentQuote.value0.year instanceof Just) {
            return span3([class_("quote-year")])([text5(" (" + (show2(state3.currentQuote.value0.year.value0) + ")"))]);
          }
          ;
          ...
          ;
          throw new Error("Failed pattern match at Main (line 238, column 19 - line 240, column 42): " + [state3.currentQuote.value0.year.constructor.name]);
        }()]), div2([class_("quote-meta")])([span3([class_("category-tag")])([text5(state3.currentQuote.value0.category)]), div2([class_("tags")])(map21(renderTag)(state3.currentQuote.value0.tags))])]);
      }
      ;
      throw new Error("Failed pattern match at Main (line 224, column 7 - line 251, column 14): " + [state3.currentQuote.constructor.name]);
  ...
  var renderCategoryOption = function(v) {
    return option([value13(v.name)])([text5(v.name)]);
  };
  var renderAuthorOption = function(author) {
    return option([value13(author)])([text5(author)]);
  };
  var handleCategoryChange = function(categories) {
    return function(idx) {
      ...
      ;
      throw new Error("Failed pattern match at Main (line 203, column 7 - line 205, column 32): " + [v.constructor.name]);
    };
  };
  var getUniqueAuthors = function(quotes) {
    return nub3(sort2(map21(function(v) {
      return v.author;
    })(quotes)));
  };
  var handleAuthorChange = function(quotes) {
    return function(idx) {
      ...
      ;
      throw new Error("Failed pattern match at Main (line 212, column 7 - line 214, column 32): " + [v.constructor.name]);
    };
  };
  var renderFilterControls = function(state3) {
    return div2([class_("filter-controls")])([input2([class_("search-input"), type_19(InputText.value), placeholder3("Search quotes or authors..."), value13(state3.searchQuery), onValueInput(SetSearchQuery.create)]), select3([onSelectedIndexChange(function(idx) {
      return handleCategoryChange(state3.categories)(idx);
    }), class_("category-select")])(append12([option([value13("")])([text5("All Categories")])])(map21(renderCategoryOption)(state3.categories))), select3([onSelectedIndexChange(function(idx) {
      return handleAuthorChange(state3.allQuotes)(idx);
    }), class_("author-select")])(append12([option([value13("")])([text5("All Authors")])])(map21(renderAuthorOption)(getUniqueAuthors(state3.allQuotes)))), button([onClick(function(v) {
      return ClearFilters.value;
  ...
  var getFilteredQuotes = function(state3) {
    ...
    var categoryFilter = function() {
      ...
      ;
      throw new Error("Failed pattern match at Main (line 74, column 22 - line 76, column 59): " + [state3.selectedCategory.constructor.name]);
    }();
    var authorFilter = function() {
      ...
      ;
      throw new Error("Failed pattern match at Main (line 78, column 20 - line 80, column 59): " + [state3.selectedAuthor.constructor.name]);
    }();
  ...
  var handleAction = function(v) {
    ...
    if (v instanceof GetRandomQuote) {
      return bind5(get2)(function(state3) {
        ...
        var $77 = length(filteredQuotes) === 0;
        if ($77) {
          return modify_3(function(v1) {
            ...
            ;
            $78.currentQuote = Nothing.value;
            return $78;
          });
        }
        ;
        return bind5(liftEffect7(randomInt(0)(length(filteredQuotes) - 1 | 0)))(function(idx) {
          ...
          if (v1 instanceof Just) {
            return modify_3(function(v2) {
              ...
              ;
              $82.currentQuote = new Just(v1.value0);
              return $82;
            });
          }
          ;
          ...
          ;
          throw new Error("Failed pattern match at Main (line 102, column 9 - line 104, column 31): " + [v1.constructor.name]);
        });
      });
    }
    ;
    if (v instanceof FilterByCategory) {
      return discard5(modify_3(function(v1) {
        ...
        ;
        $86.selectedCategory = new Just(v.value0);
        return $86;
      }))(function() {
    ...
    if (v instanceof FilterByAuthor) {
      return discard5(modify_3(function(v1) {
        ...
        ;
        $90.selectedAuthor = new Just(v.value0);
        return $90;
      }))(function() {
        return handleAction(GetRandomQuote.value);
      });
    ...
    if (v instanceof ClearFilters) {
      return discard5(modify_3(function(v1) {
        ...
        ;
        $101.selectedCategory = Nothing.value;
        $101.selectedAuthor = Nothing.value;
        $101.searchQuery = "";
        return $101;
      }))(function() {
        return handleAction(GetRandomQuote.value);
    ...
    ;
    throw new Error("Failed pattern match at Main (line 91, column 16 - line 126, column 32): " + [v.constructor.name]);
  };
  ...
  var render = function(state3) {
    return div2([class_("app-container")])([renderHeader, renderFilters(state3), renderQuoteDisplay(state3), renderStats(state3)]);
  };
  var component = /* @__PURE__ */ function() {
    var initialState = {
      currentQuote: Nothing.value,
      allQuotes: sampleData.quotes,
  ...
  var main2 = /* @__PURE__ */ runHalogenAff(/* @__PURE__ */ bind15(awaitBody)(function() {
    return bind15(selectElement("#app"))(function(app) {
      ...
      ;
      throw new Error("Failed pattern match at Main (line 326, column 3 - line 328, column 25): " + [app.constructor.name]);
    });
  }));
