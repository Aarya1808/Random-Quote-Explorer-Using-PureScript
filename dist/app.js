(() => {
  ...
  var decodeMaybe = function(decoder) {
    return function(json2) {
      ...
      ;
      if (otherwise) {
        return map9(Just.create)(decoder(json2));
      }
      ;
  ...
  var getField22 = /* @__PURE__ */ getField2(/* @__PURE__ */ decodeJsonMaybe(decodeJsonInt));
  var getField32 = /* @__PURE__ */ getField2(/* @__PURE__ */ decodeArray2(decodeJsonString));
  ...
  var GetRandomQuote = /* @__PURE__ */ function() {
    ...
    ;
    GetRandomQuote2.value = new GetRandomQuote2();
    return GetRandomQuote2;
  }();
  var FilterByCategory = /* @__PURE__ */ function() {
    function FilterByCategory2(value0) {
      this.value0 = value0;
    }
    ;
    FilterByCategory2.create = function(value0) {
      return new FilterByCategory2(value0);
    };
    return FilterByCategory2;
  }();
  var FilterByAuthor = /* @__PURE__ */ function() {
    function FilterByAuthor2(value0) {
      this.value0 = value0;
    }
    ;
    FilterByAuthor2.create = function(value0) {
      return new FilterByAuthor2(value0);
    };
    return FilterByAuthor2;
  }();
  ...
  var ToggleFilters = /* @__PURE__ */ function() {
    ...
    ;
    ToggleFilters2.value = new ToggleFilters2();
    return ToggleFilters2;
  }();
  ...
  var FetchQuotes = /* @__PURE__ */ function() {
    ...
    ;
    FetchQuotes2.value = new FetchQuotes2();
    return FetchQuotes2;
  }();
  var ReceiveQuotes = /* @__PURE__ */ function() {
    function ReceiveQuotes2(value0) {
      this.value0 = value0;
    }
    ;
    ReceiveQuotes2.create = function(value0) {
      return new ReceiveQuotes2(value0);
    };
    return ReceiveQuotes2;
  }();
  var renderTag = function(tag) {
    return span4([class_("tag")])([text5(tag)]);
  };
  var renderQuoteDisplay = function(state3) {
    return div2([class_("quote-section")])([function() {
      if (state3.currentQuote instanceof Nothing) {
        return div2([class_("quote-box")])([p_([text5("Click the button to discover a quote!")])]);
      }
      ;
      if (state3.currentQuote instanceof Just) {
        return div2([class_("quote-box active")])([blockquote([class_("quote-text")])([text5('"' + (state3.currentQuote.value0.text + '"'))]), div2([class_("quote-attribution")])([cite_([text5("\u2014 " + state3.currentQuote.value0.author)]), function() {
          if (state3.currentQuote.value0.year instanceof Just) {
            return span4([class_("quote-year")])([text5(" (" + (show2(state3.currentQuote.value0.year.value0) + ")"))]);
          }
          ;
          if (state3.currentQuote.value0.year instanceof Nothing) {
            return text5("");
          }
          ;
          throw new Error("Failed pattern match at Main (line 324, column 19 - line 326, column 42): " + [state3.currentQuote.value0.year.constructor.name]);
      ...
      ;
      throw new Error("Failed pattern match at Main (line 310, column 7 - line 337, column 14): " + [state3.currentQuote.constructor.name]);
  ...
  var renderLoading = /* @__PURE__ */ div2([/* @__PURE__ */ class_("loading")])([/* @__PURE__ */ p_([/* @__PURE__ */ text5("Loading quotes...")])]);
  var renderHeader = /* @__PURE__ */ div2([/* @__PURE__ */ class_("header")])([/* @__PURE__ */ h1_([/* @__PURE__ */ text5("\u{1F4AC} Quote Explorer Pro")]), /* @__PURE__ */ p_([/* @__PURE__ */ text5("Discover wisdom from great minds")])]);
  var renderError = function(err) {
    return div2([class_("error")])([p_([text5(err)]), button([onClick(function(v) {
      return FetchQuotes.value;
    }), class_("retry-btn")])([text5("Retry")])]);
  };
  var renderCategoryOption = function(v) {
    return option([value14(v.name)])([text5(v.name)]);
  };
  var renderAuthorOption = function(author) {
    return option([value14(author)])([text5(author)]);
  };
  var handleCategoryChange = function(categories) {
    return function(idx) {
      ...
      ;
      var v = index(categories)(idx - 1 | 0);
      if (v instanceof Just) {
  ...
  var getUniqueAuthors = function(quotes) {
    return nub3(sort2(map26(function(v) {
      return v.author;
    })(quotes)));
  };
  var handleAuthorChange = function(quotes) {
    return function(idx) {
      ...
      ;
      var v = index(getUniqueAuthors(quotes))(idx - 1 | 0);
      if (v instanceof Just) {
  ...
  var renderFilters = function(state3) {
    return div2([class_("filters-section")])([button([class_("toggle-filters-btn"), onClick(function(v) {
      return ToggleFilters.value;
    })])([text5(function() {
      if (state3.showFilters) {
        return "Hide Filters";
      }
      ;
      return "Show Filters";
      ...
      if (state3.showFilters) {
        return renderFilterControls(state3);
      }
      ;
      return div_([]);
    }()]);
  ...
  var getFilteredQuotes = function(state3) {
    var searchFilter = function() {
      var $83 = state3.searchQuery === "";
      if ($83) {
        return identity11;
      }
      ;
      return filter(function(v) {
        return contains(toLower(state3.searchQuery))(toLower(v.text)) || contains(toLower(state3.searchQuery))(toLower(v.author));
      });
    }();
    var categoryFilter = function() {
      ...
      if (state3.selectedCategory instanceof Just) {
        return filter(function(v) {
          return v.category === state3.selectedCategory.value0;
        });
      }
      ;
      throw new Error("Failed pattern match at Main (line 108, column 22 - line 110, column 59): " + [state3.selectedCategory.constructor.name]);
    }();
    var authorFilter = function() {
      ...
      if (state3.selectedAuthor instanceof Just) {
        return filter(function(v) {
          return v.author === state3.selectedAuthor.value0;
        });
      }
      ;
      throw new Error("Failed pattern match at Main (line 112, column 20 - line 114, column 59): " + [state3.selectedAuthor.constructor.name]);
    }();
    return searchFilter(authorFilter(categoryFilter(state3.allQuotes)));
  };
  var renderStats = function(state3) {
    var totalQuotes = length(state3.allQuotes);
    var filteredQuotes = getFilteredQuotes(state3);
    var filteredCount = length(filteredQuotes);
    return div2([class_("stats-section")])([p_([text5("Showing " + (show2(filteredCount) + (" of " + (show2(totalQuotes) + " quotes"))))])]);
  };
  var render = function(state3) {
    return div2([class_("app-container")])([renderHeader, function() {
      if (state3.loading) {
      ...
      if (state3.error instanceof Nothing) {
        return div_([renderFilters(state3), renderQuoteDisplay(state3), renderStats(state3)]);
      }
      ;
      throw new Error("Failed pattern match at Main (line 197, column 14 - line 203, column 14): " + [state3.error.constructor.name]);
    }()]);
  };
  var decodeQuote = function(json2) {
    return lmap3(printJsonDecodeError)(bind5(decodeJson2(json2))(function(obj) {
      return bind5(getField3(obj)("id"))(function(id3) {
        return bind5(getField1(obj)("text"))(function(text6) {
          return bind5(getField1(obj)("author"))(function(author) {
            return bind5(getField1(obj)("category"))(function(category) {
              return bind5(getField22(obj)("year"))(function(year) {
                return bind5(getField1(obj)("source"))(function(source2) {
                  return bind5(getField32(obj)("tags"))(function(tags) {
                    return pure14({
                      id: id3,
                      text: text6,
                      author,
  ...
  var decodeCategory = function(json2) {
    return lmap3(printJsonDecodeError)(bind5(decodeJson2(json2))(function(obj) {
      return bind5(getField1(obj)("name"))(function(name16) {
        return bind5(getField1(obj)("description"))(function(description) {
          return bind5(getField1(obj)("color"))(function(color) {
            return pure14({
              name: name16,
              description,
              color
  ...
  var decodeAuthor = function(json2) {
    return lmap3(printJsonDecodeError)(bind5(decodeJson2(json2))(function(obj) {
      return bind5(getField1(obj)("name"))(function(name16) {
        return bind5(getField1(obj)("bio"))(function(bio) {
          return bind5(getField3(obj)("birth_year"))(function(birth_year) {
            return bind5(getField3(obj)("quote_count"))(function(quote_count) {
              return pure14({
                name: name16,
                bio,
                birth_year,
  ...
  var decodeQuoteDatabase = function(json2) {
    return bind5(lmap3(printJsonDecodeError)(bind5(decodeJson2(json2))(function(obj) {
      return bind5(getField4(obj)("quotes"))(function(quotesJson) {
        return bind5(getField4(obj)("categories"))(function(categoriesJson) {
          return bind5(getField4(obj)("authors"))(function(authorsJson) {
            return bind5(decodeJson1(quotesJson))(function(quotesArray) {
              return bind5(decodeJson1(categoriesJson))(function(categoriesArray) {
                return bind5(decodeJson1(authorsJson))(function(authorsArray) {
                  return pure14({
                    quotesArray,
                    categoriesArray,
                    authorsArray
      ...
      return bind5(traverse3(decodeQuote)(result.quotesArray))(function(quotes) {
        return bind5(traverse3(decodeCategory)(result.categoriesArray))(function(categories) {
          return bind5(traverse3(decodeAuthor)(result.authorsArray))(function(authors) {
            return pure14({
              quotes,
              categories,
              authors
  ...
  var handleAction = function(v) {
    ...
    if (v instanceof FetchQuotes) {
      return discard5(modify_3(function(v12) {
        ...
        ;
        $95.loading = true;
        $95.error = Nothing.value;
        return $95;
      }))(function() {
        return bind15(liftAff2(get3(json)("http://localhost:8080/api/quotes")))(function(response) {
    ...
    if (v instanceof ReceiveQuotes) {
      if (v.value0 instanceof Left) {
        return modify_3(function(v12) {
          ...
          ;
          $99.loading = false;
          $99.error = new Just("Failed to load quotes from server. Please make sure the backend is running.");
          return $99;
        });
      }
      ;
      if (v.value0 instanceof Right) {
        ...
        if (v1 instanceof Left) {
          return modify_3(function(v2) {
            ...
            ;
            $104.loading = false;
            $104.error = new Just("Failed to parse quotes: " + v1.value0);
            return $104;
          });
        }
        ;
    ...
    if (v instanceof GetRandomQuote) {
      return bind15(get4)(function(state3) {
        var filteredQuotes = getFilteredQuotes(state3);
        var $115 = length(filteredQuotes) === 0;
        if ($115) {
          return modify_3(function(v12) {
            var $116 = {};
            for (var $117 in v12) {
            ...
            ;
            $116.currentQuote = Nothing.value;
            return $116;
          });
        }
        ;
        return bind15(liftEffect7(randomInt(0)(length(filteredQuotes) - 1 | 0)))(function(idx) {
          ...
          if (v12 instanceof Just) {
            return modify_3(function(v2) {
              ...
              ;
              $120.currentQuote = new Just(v12.value0);
              return $120;
            });
          }
          ;
          ...
          ;
          throw new Error("Failed pattern match at Main (line 164, column 9 - line 166, column 31): " + [v12.constructor.name]);
        });
      });
    }
    ;
    if (v instanceof FilterByCategory) {
      return discard5(modify_3(function(v12) {
        ...
        ;
        $124.selectedCategory = new Just(v.value0);
        return $124;
      }))(function() {
        return handleAction(GetRandomQuote.value);
      });
    ...
    if (v instanceof FilterByAuthor) {
      return discard5(modify_3(function(v12) {
        ...
        ;
        $128.selectedAuthor = new Just(v.value0);
        return $128;
      }))(function() {
        return handleAction(GetRandomQuote.value);
      });
    ...
    if (v instanceof SetSearchQuery) {
      return modify_3(function(v12) {
        var $132 = {};
        for (var $133 in v12) {
          if ({}.hasOwnProperty.call(v12, $133)) {
            $132[$133] = v12[$133];
          }
          ;
        }
    ...
    if (v instanceof ClearFilters) {
      return discard5(modify_3(function(v12) {
        ...
        ;
        $139.selectedCategory = Nothing.value;
        $139.selectedAuthor = Nothing.value;
        $139.searchQuery = "";
        return $139;
      }))(function() {
        return handleAction(GetRandomQuote.value);
  ...
  var component = /* @__PURE__ */ function() {
    var initialState = {
      currentQuote: Nothing.value,
      allQuotes: [],
      categories: [],
      authors: [],
      selectedCategory: Nothing.value,
      selectedAuthor: Nothing.value,
      searchQuery: "",
      showFilters: false,
      loading: false,
      error: Nothing.value
  ...
  var main2 = /* @__PURE__ */ runHalogenAff(/* @__PURE__ */ bind22(awaitBody)(function() {
    return bind22(selectElement("#app"))(function(app) {
      if (app instanceof Just) {
        return $$void8(runUI2(component)(unit)(app.value0));
      }
      ;
